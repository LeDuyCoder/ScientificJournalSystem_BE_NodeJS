...
const isLocal = process.env.NODE_ENV === 'test' || process.env.CI || (process.env.POSTGRES_URL && (process.env.POSTGRES_URL.includes("localhost") || process.env.POSTGRES_URL.includes("127.0.0.1") || process.env.POSTGRES_URL.includes("host.docker.internal") || process.env.POSTGRES_URL.includes("100.121.61.95")));
