  ...
  schema: {
    ...
    querystring: {
      ...
      properties: {
        ...
        subject_area_ids: { type: "string" },
        subject_area_id: { type: ["string", "integer"] },
        subjectCategoryIds: { type: "string" },
        subject_category_ids: { type: "string" },
        subject_category_id: { type: ["string", "integer"] },
        isOpenAccess: { type: "boolean" },
        is_open_access: { type: ["boolean", "string"] },
        quartiles: { type: "string" },
        rankingYear: { type: "integer" },
        ranking_year: { type: ["integer", "string"] },
        isOaDiamond: { type: "boolean" },
        is_oa_diamond: { type: ["boolean", "string"] },
        countryIds: { type: "string" },
        country_ids: { type: "string" },
        country_id: { type: ["string", "integer"] },
