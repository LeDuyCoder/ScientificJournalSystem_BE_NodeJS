...
export const publisherExist = async (id) => {
    try {
        ...
        logger.error(`[Repository Error] Lỗi khi kiểm tra publisherExist với ID ${id}:`, error);
        throw error; 
    }
};
...
export const publisherIsDeleted = async (id) => {
    try {
        ...
        logger.error(`[Repository Error] Lỗi khi kiểm tra publisherIsDeleted với ID ${id}:`, error);
        throw error;
    }
};
...
export const getPublishers = async ({ page = 1, limit = 100, search = '' }) => {
    try {
        ...
        logger.error('[Repository Error] Lỗi khi lấy danh sách publisher:', error);
        throw error;
    }
};
...
export const getPublisherById = async (id) => {
    try {
        ...
        logger.error(`[Repository Error] Lỗi khi lấy publisher ${id}:`, error);
        throw error;
    }
};
...
export const createPublisher = async (data) => {
    try {
        ...
        logger.error('[Repository Error] Lỗi khi tạo publisher:', error);
        throw error;
    }
};
...
export const updatePublisher = async (id, data) => {
    try {
        ...
        logger.error(`[Repository Error] Lỗi khi cập nhật publisher ${id}:`, error);
        throw error;
    }
};
...
export const deletePublisher = async (id) => {
    try {
        ...
        logger.error(`[Repository Error] Lỗi khi xóa publisher ${id}:`, error);
        throw error;
    }
};
...
export const restorePublisher = async (id) => {
    try {
        ...
        logger.error(`[Repository Error] Lỗi khi khôi phục publisher ${id}:`, error);
        throw error;
    }
};
