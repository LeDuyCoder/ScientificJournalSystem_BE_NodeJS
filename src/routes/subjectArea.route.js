 ...
 */
router.post("/", verifyToken, verifyAdmin, validateCreateSubjectArea, createSubjectArea);
 ...
 *         description: Lỗi hệ thống
 */
router.delete("/:id", verifyToken, verifyAdmin, validateSubjectAreaId, deleteSubjectArea);
 ...
 *         description: Lỗi hệ thống
 */
router.patch("/:id/restore", verifyToken, verifyAdmin, validateSubjectAreaId, restoreSubjectArea);
