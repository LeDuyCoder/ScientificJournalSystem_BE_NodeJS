...
import { getArticlesByKeywords, countArticlesByKeywords, getAllArticles, countAllArticles } from '../../../src/services/article.service.js';
...
test.describe('Article Service - getArticlesByKeywords() Unit Test Suite', () => {
  ...
  test.beforeEach(() => {
    ...
    mock.method(cacheService, 'del', async () => {});
    mock.method(cacheService, 'delByPattern', async () => {});
  });
